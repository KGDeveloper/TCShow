...
- (void)drawRect:(CGRect)rect {
    ...
    if (self.isTriangle) {
        startX += width/2 - Triangle/2;
        
        CGFloat endX = startX + Triangle;
        
        CGContextMoveToPoint(ctx, startX, height/2 + 5);
        CGContextAddLineToPoint(ctx, endX, height/2 + 5);
        CGContextAddLineToPoint(ctx, startX + Triangle/2, 30);
