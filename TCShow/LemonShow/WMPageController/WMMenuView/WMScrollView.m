...
//    if ([otherGestureRecognizer.view isKindOfClass:NSClassFromString(@"UITableViewCellContentView")] && [otherGestureRecognizer isKindOfClass:[UIPanGestureRecognizer class]]) {
//        return YES;
//    }
    
    if ([otherGestureRecognizer.view isKindOfClass:NSClassFromString(@"WKScrollView")]) {
        return YES;
    }
    if ([otherGestureRecognizer.view isKindOfClass:NSClassFromString(@"WKGoodsSliderCollectionView")]) {
        return YES;
    }
