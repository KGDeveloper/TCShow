...
- (void)loadMoreData {
    ...
    [[Business sharedInstance] getFollowLives:[NSString stringWithFormat:@"%ld", (long)_pageIndex] uid:[SARUserInfo userId] isConcernLives:NO type:@"1" succ:^(NSString *msg, id dataList) {
...
-(void)collectionView:(UICollectionView *)collectionView didSelectItemAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if ([string isEqual:[NSNull null]] || string==nil) {
        ...
        [[HUDHelper sharedInstance] tipMessage:@"暂未开播"];
