...
{
    self.frame = CGRectMake(0, kSCREEN_HEIGHT, kSCREEN_WIDTH, self.frame.size.height);
    [view addSubview:self];
    
    [UIView animateWithDuration:0.3 animations:^{
        self.frame = CGRectMake(0, view.frame.size.height - self.frame.size.height, kSCREEN_WIDTH, self.frame.size.height);
    }];
