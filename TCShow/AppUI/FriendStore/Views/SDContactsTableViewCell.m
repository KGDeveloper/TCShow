...
- (void)setModel:(TCLiveUserList *)model
{
    _model = model;
    _nameLabel.text = [NSString stringWithFormat:@"%@",model.nickname];
    [_iconImageView sd_setImageWithURL:[NSURL URLWithString:IMG_APPEND_PREFIX(model.headsmall)] placeholderImage:IMAGE(@"friend_default_head")];
}
