...
@interface HomeCityChooseController ()<GYZCityGroupCellDelegate,UISearchBarDelegate,CLLocationManagerDelegate>
/**
 *  记录所有城市信息，用于搜索
 */
...
@implementation HomeCityChooseController
...
-(void)locationInfo{
    ...
    if (self.localCityData.count <= 0) {
        GYZCity *city = [[GYZCity alloc] init];
        city.cityName = _currCity;
        city.shortName = _currCity;
