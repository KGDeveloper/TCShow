...
@interface TCTariffTableController (){
    MJRefreshNormalHeader *_header;
}
@property (nonatomic,strong)NSMutableArray *dataArr;
@end

@implementation TCTariffTableController
...
-(void)loadData{
    ...
    } name:self.searchName goodsID:nil order:self.searchType page:nil];
}
