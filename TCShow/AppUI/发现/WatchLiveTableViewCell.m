...
- (IBAction)report:(id)sender
{
    ...
    alert.action = ^(NSString *reportContent) {
        [[Business sharedInstance] liveReport:[SARUserInfo userId] accuse_id:[IMAPlatform sharedInstance].host.userId cause:reportContent complement:nil succ:^(NSString *msg, id data) {
...
- (instancetype)initVideoWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier
{
    ...
    self.liveStatusView.backgroundColor = RGBA(240, 140, 27, 1);
